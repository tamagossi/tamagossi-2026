...
const Tag = ({ children }: { children: React.ReactNode }) => (
	<span className="font-mono text-xs border border-accent/30 text-accent rounded-full px-3 py-1 bg-transparent">
		{children}
	</span>
);
	...
	const data = [
		{
			...
			content: (
				<div className="space-y-4">
					...
					<p className="text-foreground/80 font-sans font-light leading-relaxed">
						Leading a chapter of engineers across product squads. Define engineering
						standards, conduct technical reviews, and ship core platform features in
						Next.js and Go Fiber.
					</p>
		...
		},
		{
			...
			content: (
				<div className="space-y-4">
					...
					<p className="text-foreground/80 font-sans font-light leading-relaxed">
						Built and maintained high-traffic consumer products. Owned full delivery
						from API design to frontend implementation with focus on performance and DX.
					</p>
					<div className="flex flex-wrap gap-2 pt-2">
						<Tag>React</Tag>
						<Tag>Node.js</Tag>
		...
		},
		{
			...
			content: (
				<div className="space-y-4">
					...
					<p className="text-foreground/80 font-sans font-light leading-relaxed">
						Delivered client projects for e-commerce and media brands. First real
						exposure to performance optimization and cross-browser compatibility at
						scale.
					</p>
					<div className="flex flex-wrap gap-2 pt-2">
						<Tag>HTML/CSS</Tag>
